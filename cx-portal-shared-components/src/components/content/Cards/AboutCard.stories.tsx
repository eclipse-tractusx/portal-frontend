...
AboutCards.args = {
  ...
  noticePath: 'https://github.com/eclipse-tractusx/example-product/blob/v1.0.0-example/NOTICE.md',
  sourcePath: 'https://github.com/eclipse-tractusx/example-product/tree/v1.0.0-example',
