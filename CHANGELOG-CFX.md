...
- **Shared Components**
  ...
  - Part 2: Replace additional buttons with Cfx Buttons and add missing data-testids [PM2-3419](https://cofinity-x.atlassian.net/browse/PM2-3419)
  - Part 3: Replace additional buttons with Cfx Buttons and add missing data-testids [PM2-3422](https://cofinity-x.atlassian.net/browse/PM2-3422)
...
- **Homepage improvements**
  ...
  - redirect user back to configured tanent url [PM2-3368](https://cofinity-x.atlassian.net/browse/PM2-3368)
...
- **PostHog normal session recording**
  ...
  - Remove dysfunctional user search from global search bar and ensure recording privacy [PM2-3184](https://cofinity-x.atlassian.net/browse/PM2-3184)
...
- **Connector Registration**
  ...
  - Extend connector enhance url validation [PM2-3376](https://cofinity-x.atlassian.net/browse/PM2-3376)
...
- **BP Explorer**
  - Pagination controls visible in company address Table's footer [PM2-3445](https://cofinity-x.atlassian.net/browse/PM2-3445)
...
- **User Management**
  - Fix CSV upload for user creation [PTQ-1](https://cofinity-x.atlassian.net/browse/PTQ-1)
...
- **Environment Service**
  ...
  - Remove token display from INT [PM2-2484](https://cofinity-x.atlassian.net/browse/PM2-2484)
...
- **BP Explorer**
  ...
  - BPX headline translations [PM2-2604](https://cofinity-x.atlassian.net/browse/PM2-2604)
