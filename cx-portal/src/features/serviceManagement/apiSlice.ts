...
export const apiSlice = createApi({
  ...
  endpoints: (builder) => ({
    ...
    createService: builder.mutation<void, createServiceType>({
      query: (data) => ({
        url: `/api/serviceRelease/addservice`,
        method: 'POST',
        body: data.body,
      }),
    }),
    saveService: builder.mutation<void, createServiceType>({
      query: (data) => ({
        url: `/api/serviceRelease/${data.id}`,
        method: 'PUT',
        body: data.body,
      }),
    }),
    ...
    updateServiceDocumentUpload: builder.mutation({
      async queryFn(
        ...
        const response = await fetchWithBaseQuery({
          url: `/api/serviceRelease/updateservicedoc/${data.appId}/documentType/${data.documentTypeId}/documents`,
          method: 'PUT',
          body: formData,
        })
    ...
    submitService: builder.mutation<any, string>({
      query: (id) => ({
        url: `/api/serviceRelease/${id}/submit`,
        method: 'PUT',
      }),
    }),
